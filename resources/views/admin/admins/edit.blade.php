...
<div class="main-content">
    <div class="container">
        <div class="page-header">
            <div>
                <h2 class="main-content-title">Edit Admin</h2>
                @if (session('status'))
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    <h6 class="card-title mb-1">Edit Admin</h6>
                                </div>
                                <form action="{{ route('admin.update', $admin->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" placeholder="Enter first_name" value="{{$admin->first_name}}"
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" placeholder="Enter last_name" value="{{$admin->last_name}}"
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" placeholder="Enter email" value="{{$admin->email}}"
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" placeholder="phone" value="{{$admin->phone}}"
